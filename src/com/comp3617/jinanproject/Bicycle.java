...
public class Bicycle extends Activity {
    ...
    private final int bicycleCal = 8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(Bicycle.this, "Failed to open database!",
        ...
        Toast.makeText(this, timeSpent + "", Toast.LENGTH_SHORT).show();
    }

    public void backToExercise(View view) {
        Intent execisePage = new Intent(Bicycle.this, Exercise.class);
    ...
    public void submitToExercise(View view) {
        ...
        execisePage.putExtra("cal", bicycleCal);
        execisePage.putExtra("newTotalCal", tempTotalCal);
