...
public class Donut extends Activity implements OnSeekBarChangeListener {
    String[] presidents;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presidents =
                getResources().getStringArray(R.array.donut_array);
        ...
        Toast.makeText(Donut.this, selectedCategory + "", Toast.LENGTH_LONG).show();
    ...
    public void submitToCalorie(View view) {
        Intent caloriePage=new Intent(Donut.this,Calorie.class);
