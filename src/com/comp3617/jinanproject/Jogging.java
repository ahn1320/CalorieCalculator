...
public class Jogging extends Activity {
    ...
    private final int joggingCal = 9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(Jogging.this, "Failed to open database!",
    ...
    public void submitToExercise(View view) {
        Intent execisePage = new Intent(Jogging.this, Exercise.class);
        execisePage.putExtra("totalTime", timeSpent);
        execisePage.putExtra("cal", joggingCal);
        execisePage.putExtra("newTotalCal", tempTotalCal);
