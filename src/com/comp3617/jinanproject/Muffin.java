...
public class Muffin extends Activity implements OnSeekBarChangeListener {
    String[] presidents;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presidents = getResources().getStringArray(R.array.muffin_array);
        ...
        Toast.makeText(Muffin.this, selectedCategory + "", Toast.LENGTH_LONG)
                .show();
    ...
    public void submitToCalorie(View view) {
        Intent caloriePage = new Intent(Muffin.this, Calorie.class);
