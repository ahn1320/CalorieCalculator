...
public class Sandwich extends Activity implements OnSeekBarChangeListener {
    String[] presidents;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presidents = getResources().getStringArray(R.array.sandwich_array);
    ...
    public void submitToCalorie(View view) {
        Intent caloriePage = new Intent(Sandwich.this, Calorie.class);
